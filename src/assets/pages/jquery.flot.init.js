...
! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		var datas = [20, 30, 15];
		var colors = ['#3f51b5', '#03a9f3', '#52bb56'];
		this.createPieGraph("#pie-chart #pie-chart-container", pielabels, datas, colors);

		//real time data representation
		var plot = this.createRealTimeGraph('#flotRealTime', this.randomData(), ['#3f51b5']);
		plot.draw();
		var $this = this;
		function updatePlot() {
		...
		var donutcolors = ['#3f51b5', '#03a9f3', '#52bb56', "#ee6e73"];
